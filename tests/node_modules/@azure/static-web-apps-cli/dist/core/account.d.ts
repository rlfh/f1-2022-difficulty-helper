...
export declare function listStaticSites(credentialChain: TokenCredential, subscriptionId: string, resourceGroupName?: string): Promise<StaticSiteARMResource[]>;
export declare function getStaticSiteDeployment(credentialChain: TokenCredential, subscriptionId: string, resourceGroupName: string, staticSiteName: string): Promise<import("@azure/arm-appservice").StringDictionary>;
