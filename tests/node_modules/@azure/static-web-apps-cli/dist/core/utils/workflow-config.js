...
function readWorkflowFile({ userWorkflowConfig } = {}) {
    ...
    logger_1.logger.silly(`Trying to read workflow config with values:`);
    logger_1.logger.silly(userWorkflowConfig);
    if (userWorkflowConfig) {
        // is dev servers? Skip reading workflow file
        isAppDevServer = (0, net_1.isHttpUrl)(userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.outputLocation);
        isApiDevServer = (0, net_1.isHttpUrl)(userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.apiLocation);
        if (isAppDevServer && isApiDevServer) {
            logger_1.logger.silly(`Detected dev server configuration`);
    ...
    if (fs_1.default.existsSync(githubActionFolder) === false) {
        logger_1.logger.silly(`No workflow config folder found at ${githubActionFolder}`);
        // no github actions folder found
        return userWorkflowConfig && (0, user_config_1.validateUserWorkflowConfig)(userWorkflowConfig);
    }
    ...
    let githubActionFile = fs_1.default
        ...
        .pop();
    if (!githubActionFile) {
        logger_1.logger.silly(`No SWA workflow config entry found under ${githubActionFolder}. Skipping`);
        // no SWA workflow file found
        return userWorkflowConfig && (0, user_config_1.validateUserWorkflowConfig)(userWorkflowConfig);
    }
    githubActionFile = path_1.default.resolve(githubActionFolder, githubActionFile);
    // does the config file exist?
    if (fs_1.default.existsSync(githubActionFile) === false) {
        logger_1.logger.silly(`No workflow config file found at ${path_1.default.resolve(githubActionFile)}. Skipping`);
        // no SWA workflow file found
        return userWorkflowConfig && (0, user_config_1.validateUserWorkflowConfig)(userWorkflowConfig);
    }
    logger_1.logger.silly(`Found a SWA workflow file: ${githubActionFile}`);
    ...
    let { app_build_command = (userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.appBuildCommand) || config_1.DEFAULT_CONFIG.appBuildCommand, api_build_command = (userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.apiBuildCommand) || config_1.DEFAULT_CONFIG.apiBuildCommand, app_location = (userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.appLocation) || config_1.DEFAULT_CONFIG.appLocation, output_location = (userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.outputLocation) || config_1.DEFAULT_CONFIG.outputLocation, api_location = (userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.apiLocation) || config_1.DEFAULT_CONFIG.apiLocation, } = swaBuildConfig.with;
    ...
    if (userWorkflowConfig) {
        userWorkflowConfig = (0, user_config_1.validateUserWorkflowConfig)(userWorkflowConfig);
    ...
    logger_1.logger.silly(`Workflow configuration:`);
