...
async function run(argv) {
  ...
  `);
    // Register commands
    (0, login_1.default)(commander_1.program);
    (0, start_1.default)(commander_1.program);
    (0, deploy_1.default)(commander_1.program);
    (0, init_1.default)(commander_1.program);
    (0, build_1.default)(commander_1.program);
    (0, docs_1.default)(commander_1.program);
