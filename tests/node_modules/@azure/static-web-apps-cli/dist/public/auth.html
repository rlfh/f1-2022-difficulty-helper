...
<html lang="en">
  ...
  <body>
    ...
    <footer>
      <div>Azure Static Web Apps emulator (<a rel="noopener noreferrer" target="_blank" href="https://github.com/Azure/static-web-apps-cli/commit/9c02b5d">main+sha.9c02b5d</a>)</div>
      <nav>
        <ul>
